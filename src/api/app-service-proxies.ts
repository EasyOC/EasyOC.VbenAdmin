...
export class ContentManagementServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    getPartDefinition(params:{ name: string | undefined, incloudeSettings: boolean | undefined }): Promise<ContentPartApiModel> {
    ...
    * @return Success
    */
    getTypeDefinition(params:{ name: string | undefined, incloudeSettings: boolean | undefined }): Promise<ContentTypeApiModel> {
        const { name, incloudeSettings } = {...params}; 
...
export class ContentMappingServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    getRDBMSMappingContentTypeResult(params:{ tableName: string | undefined, contentTypeName: string | undefined }): Promise<any> {
...
export class UserServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    getAll(params:{ searchText: string | undefined, selectedRole: string | undefined, sortField: string | undefined, sortOrder: string | undefined, page: number | undefined, pageSize: number | undefined }): Promise<PagedResultDtoOfUserDto> {
...
export class ContentFiledsApiModel {
    ...
    init(_data?: any, _mappings?: any) {
        if (_data) {
            ...
            this.fieldTypeName = _data["fieldTypeName"] !== undefined ? _data["fieldTypeName"] : <any>null;
