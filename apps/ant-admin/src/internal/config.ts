import type { GlobEnvConfig, GlobConfig } from '@pkg/types'
import { warn, getAppConfigFileName } from '@pkg/utils'
...
export const getGlobalConfig = (): Readonly<GlobConfig> => {
  ...
  const glob: Readonly<GlobConfig> = {
    ...
    amisEditorUrl: VITE_GLOB_amisEditor,
  }
