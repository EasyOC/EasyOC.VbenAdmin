<template>
  <a-tree-select v-bind="getAttrs" v-model:value="model[field].contentItemids[0]" @change="handleChange">
...
import { isArray, isFunction, get } from '@pkg/utils'
import { LoadingOutlined } from '@ant-design/icons-vue'
// export default defineComponent({
//   name: 'ContentTreeSelect',
