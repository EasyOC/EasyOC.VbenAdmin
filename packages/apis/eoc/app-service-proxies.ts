...
export class ApiServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    excel(params:{ queryName: string | undefined, typeName: string | undefined, body: { [key: string]: any; } | undefined }): Promise<void> {
...
export class ContentManagementServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    delete(contentItemId: string | undefined): Promise<boolean> {
    
        let url_ = this.baseUrl + "/api/ContentManagement/Delete?";
        
        
        
        
         if (contentItemId !== undefined && contentItemId !== null)
            url_ += "contentItemId=" + encodeURIComponent("" + contentItemId) + "&";
                    url_ = url_.replace(/[?&]$/, "");
        let options_ = <AxiosRequestConfig>{
            method: "DELETE",
            url: url_,
...
export class ContentTypeManagementServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    getAllTypes(params:{ stereotype: Stereotype | undefined, filter: string | undefined, page: number | undefined, pageSize: number | undefined }): Promise<PagedResultOfContentTypeListItemDto> {
...
export class DynamicIndexServiceProxy extends AppServiceBase {
    private instance: VAxios;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class SessionServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    getCurrentUserInfo(): Promise<UserDetailsDto> {
    
        let url_ = this.baseUrl + "/api/Session/GetCurrentUserInfo";
            url_ = url_.replace(/[?&]$/, "");
        let options_ = <AxiosRequestConfig>{
            method: "GET",
            url: url_,
    ...
    */
    menus(): Promise<string[]> {
        ...
        let url_ = this.baseUrl + "/api/Session/Menus";
            url_ = url_.replace(/[?&]$/, "");
        let options_ = <AxiosRequestConfig>{
            method: "POST",
            url: url_,
...
export class ContentFieldOption {
    ...
    static fromJS(data: any, _mappings?: any): ContentFieldOption {
        data = typeof data === 'object' ? data : {};
        return createInstance<ContentFieldOption>(data, _mappings, ContentFieldOption);
    }
...
export class ContentFieldsMappingDto {
    ...
    static fromJS(data: any, _mappings?: any): ContentFieldsMappingDto {
        data = typeof data === 'object' ? data : {};
        return createInstance<ContentFieldsMappingDto>(data, _mappings, ContentFieldsMappingDto);
    }
...
export class DynamicIndexConfigModel {
    ...
    static fromJS(data: any, _mappings?: any): DynamicIndexConfigModel {
        data = typeof data === 'object' ? data : {};
        return createInstance<DynamicIndexConfigModel>(data, _mappings, DynamicIndexConfigModel);
    }
...
如果小于0 代表不限制长度 */
    ...
    static fromJS(data: any, _mappings?: any): DynamicIndexFieldItem {
        data = typeof data === 'object' ? data : {};
        return createInstance<DynamicIndexFieldItem>(data, _mappings, DynamicIndexFieldItem);
    }
