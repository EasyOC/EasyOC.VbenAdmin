...
export class UsersServiceProxy extends AppServiceBase {
    ...
    * @return Success
    */
    fillAdditionalData(incloudeItemDetails: boolean | undefined, body: User[] | undefined): Promise<void> {
        ...
        let url_ = this.baseUrl + "/api/Users/FillAdditionalData?";
         ...
         if (incloudeItemDetails !== undefined && incloudeItemDetails !== null)
            url_ += "incloudeItemDetails=" + encodeURIComponent("" + incloudeItemDetails) + "&";
                    url_ = url_.replace(/[?&]$/, "");
        const content_ = JSON.stringify(body);
        let options_ = <AxiosRequestConfig>{
            data: content_,
...
export class User {
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.loginInfos)) {
            data["loginInfos"] = [];
            for (let item of this.loginInfos)
                data["loginInfos"].push(item.toJSON());
        }
